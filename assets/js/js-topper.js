(function (root) {
    ...
    var common = {
        ...
        Protected = function (selector, options) {
            ...
            sheet.insertRule('.' + this.id + '{position:fixed!important;' + ((this.settings.container === document.body) ? 'top:' + this.settings.stickTop + 'px!important;' : '') + 'z-index:100!important;width:' + width + 'px!important;min-height:' + height + 'px!important}', sheet.cssRules ? sheet.cssRules.length : 0);
            ...
            if (this.settings.container !== document.body) {
                this.settings.container.addEventListener('scroll', this.scrollAction.bind(this));
            } else {
