...
"incorrect"):d&&b.rules[e]&&!b.rules[e](f,g)&&(""===f?(d=!1,l="empty"):(d=!1,l="incorrect")),d)b.hideErrors(c[a].handle,!0);else{b.errors=b.errors||{};try{try{k=b.settings.messages[b.settings.locale][e][l]}catch(t){k=b.messages[b.settings.locale][e][l]}}catch(t){e="required",k=b.messages[b.settings.locale][e][l]}!g.length&&g.push(f);b.errors[a]={name:c[a].name,errorText:b.formatString(k,g)};b.submitCallback||(b.errors[a].handle=c[a].handle)}})});return this.submitCallback?this.errors?!1:!0:this.errors||
!0},hideErrors:function(a,b){var c=this,d;Object.keys(this.fields).forEach(function(e){if(a&&a===c.fields[e].handle||!a)d=c.fields[e].handle.nextElementSibling,b&&c.fields[e].handle.classList.remove(c.settings.errorClassName),d&&"validator-error"===d.getAttribute("data-type")&&d.parentNode.removeChild(d)})},showErrors:function(a){var b=this,c,d=function(a,d){a.classList.add(b.settings.errorClassName);a.nextElementSibling&&"validator-error"===a.nextElementSibling.getAttribute("data-type")||!b.settings.showErrors||
(c=document.createElement("div"),c.setAttribute("class",b.settings.errorClassName),c.setAttribute("data-type","validator-error"),c.innerHTML=d.errorText,a.parentNode.insertBefore(c,a.nextSibling))};Object.keys(this.errors).forEach(function(c){a?Object.keys(b.fields).forEach(function(e){b.fields[e].handle.getAttribute("name")===a.getAttribute("name")&&d(b.fields[e].handle,b.errors[c])}):("0"===c||0<c&&b.fields[c].name!==b.fields[c-1].name)&&d(b.fields[c].handle,b.errors[c])});this.settings.autoHideErrors&&
(a?(a.intervalID&&clearTimeout(a.intervalID),this.intervalID||(a.intervalID=setTimeout(function(){a.intervalID=null;b.hideErrors(a)},this.settings.autoHideErrorsTimeout))):(this.intervalID&&clearTimeout(this.intervalID),this.intervalID=setTimeout(function(){b.intervalID=null;b.hideErrors(!1)},this.settings.autoHideErrorsTimeout)))},getFormHandle:function(){return this.formHandle},formatString:function(a,b){return a.replace(/\{(\d+)\}/gi,function(a,d){return a&&b[d]?b[d]:""})},destroy:function(){this.hideErrors(!1,
!0);this.eventsBuilder("removeEventListener")},reload:function(a,b){this.destroy();switch(arguments.length){case 2:this.submitCallback=a;this.settings=b;break;case 1:this.settings=a}this.fields=this.getFields(this.formHandle.querySelectorAll("[data-rule]"));this.submitCallback&&this.eventsBuilder("addEventListener");this.applySettings(b||{})},eventsBuilder:function(a){var b=this;this.formHandle[a]("submit",this._eventSubmit);this.settings.onAir&&Object.keys(this.fields).forEach(function(c){[].forEach.call(b.settings.eventsList,
function(d){if("keyup"===d)b.fields[c].handle[a](d,b._eventChangeWithDelay);else b.fields[c].handle[a](d,b._eventChange)})})}};q.Validator=function(){var a=function(a,b){function c(){return a.apply(this,b)}c.prototype=a.prototype;return new c}(m,arguments),b=function(){};b.prototype={};[].forEach.call(r,function(c){b.prototype[c]=function(){return a[c].apply(a,arguments)}});return new b(arguments)}})(this);